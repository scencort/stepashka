// интерактивный 3D-глобус из бинарных цифр (0 и 1) — чисто canvas2D без WebGL
// точки располагаются на континентах (полигоны в equirectangular проекции)
// анимации: вращение, пульсирующие кольца "активных студентов", летящие дуги между точками
// используется на лендинге в секции сообщества
