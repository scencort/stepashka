...
const STORAGE_KEY = "gradus_mock_api_v1";
const USERS_RESET_MARKER_KEY = "gradus_mock_users_reset_v1";
const LEGACY_EN_NORMALIZE_MARKER_KEY = "gradus_mock_en_normalized_v1";
const ACCESS_TOKEN_KEY = "gradus_access_token";
const REFRESH_TOKEN_KEY = "gradus_refresh_token";
const MOCK_RESET_CODE_KEY = "gradus_mock_reset_code";
const MOCK_EMAIL_CHANGE_CODE_KEY = "gradus_mock_email_change_code";
const MOCK_2FA_CODE_KEY = "gradus_mock_2fa_code";
const MOCK_2FA_LOGIN_CHALLENGE_KEY = "gradus_mock_2fa_login_challenge";
...
function normalizeLegacyMockDb(db: MockDb) {
  db.courses = db.courses.map((course) => {
    ...
    const price =
      course.price === "Free" ? "Бесплатно" : String(course.price || "");
  ...
  db.tracks = db.tracks.map((track) => ({
    ...
    status:
      track.status === "в процессе"
        ? "in progress"
        : track.status === "план"
          ? "planned"
          : track.status === "завершен"
            ? "completed"
            : track.status,
  }));
  ...
  db.analyticsPoints = {
    week:
      (db.analyticsPoints as Record<string, number[]>).week ||
      (db.analyticsPoints as Record<string, number[]>)["неделя"] ||
      [],
    month:
      (db.analyticsPoints as Record<string, number[]>).month ||
      (db.analyticsPoints as Record<string, number[]>)["месяц"] ||
      [],
  };
}
...
function createSeed(): MockDb {
  return {
    ...
    notifications: [
      {
        id: 1,
        title: 'Новая задача в курсе "React Architecture"',
        time: "5 минут назад",
      },
    ...
    courseSteps: [
      {
        id: 1,
        courseId: 1,
        title: "Python и область применения",
        kind: "theory",
        theoryText:
          "Python используют для веба, автоматизации, анализа данных и ML. Ключевая идея языка - читаемость кода.",
        options: [],
        correctOption: "",
        codeKeyword: "",
        stepOrder: 1,
      ...
      },
      {
        ...
        kind: "theory",
        theoryText:
          "В Python переменные динамически типизированы. Один и тот же идентификатор может хранить значения разных типов.",
        options: [],
        correctOption: "",
        codeKeyword: "",
        stepOrder: 2,
      ...
      },
      {
        ...
        kind: "theory",
        theoryText:
          "Ветвление позволяет выполнить разный код в зависимости от условия. Отступы в Python обязательны.",
        options: [],
        correctOption: "",
        codeKeyword: "",
        stepOrder: 3,
      ...
      },
      {
        ...
        kind: "theory",
        theoryText:
          "for обычно используют с range() или коллекциями. while выполняется, пока условие истинно.",
        options: [],
        correctOption: "",
        codeKeyword: "",
        stepOrder: 4,
      ...
      },
      {
        ...
        kind: "theory",
        theoryText:
          "Функции объявляются через def. Оператор return возвращает значение вызывающему коду.",
        options: [],
        correctOption: "",
        codeKeyword: "",
        stepOrder: 5,
      ...
      },
      {
        ...
        kind: "theory",
        theoryText:
          "list хранит упорядоченные элементы, dict хранит пары ключ-значение. Оба типа часто используются в реальных задачах.",
        options: [],
        correctOption: "",
        codeKeyword: "",
        stepOrder: 6,
      ...
      },
      {
        id: 7,
        courseId: 1,
        title: "Срезы и индексация",
        kind: "theory",
        theoryText:
          "Срезы позволяют получать подстроки и подсписки: s[1:4], s[::-1]. Индексация начинается с нуля.",
        options: [],
        correctOption: "",
        codeKeyword: "",
        stepOrder: 7,
      ...
      },
      {
        ...
        kind: "theory",
        theoryText:
          "Конструкция try/except защищает код от аварийного завершения и позволяет корректно обработать ошибки.",
        options: [],
        correctOption: "",
        codeKeyword: "",
        stepOrder: 8,
      ...
      },
      {
        ...
        kind: "theory",
        theoryText:
          "with open(...) as f: автоматически закрывает файл. Это безопаснее, чем manual close().",
        options: [],
        correctOption: "",
        codeKeyword: "",
        stepOrder: 9,
      ...
      },
      {
        ...
        kind: "theory",
        theoryText:
          "Генераторы экономят память и отдают значения по одному. Это полезно при больших наборах данных.",
        options: [],
        correctOption: "",
        codeKeyword: "",
        stepOrder: 10,
      ...
      },
      {
        id: 11,
        courseId: 1,
        title: "ООП: класс, объект, метод",
        kind: "theory",
        theoryText:
          "Классы описывают структуру и поведение объектов. self ссылается на текущий экземпляр.",
        options: [],
        correctOption: "",
        codeKeyword: "",
        stepOrder: 11,
      ...
      },
      {
        id: 12,
        courseId: 1,
        title: "Импорты и структура проекта",
        kind: "theory",
        theoryText:
          "Разбивайте код по модулям. Используйте явные импорты и понятные имена пакетов.",
        options: [],
        correctOption: "",
        codeKeyword: "",
        stepOrder: 12,
...

      {
        id: 13,
        courseId: 1,
        title: "Какой тип хранит текст?",
        kind: "quiz",
        theoryText: "",
        options: ["str", "int", "float", "dict"],
        correctOption: "str",
        codeKeyword: "",
        stepOrder: 13,
        xp: 10,
      ...
      },
      {
        id: 15,
        courseId: 1,
        title: "Как объявить функцию в Python?",
        kind: "quiz",
        theoryText: "",
        options: [
          "def my_func():",
      ...
      },
      {
        id: 17,
        courseId: 1,
        title: "Какой цикл подходит для range(10)?",
        kind: "quiz",
        theoryText: "",
      ...
      },
      {
        id: 18,
        courseId: 1,
        title: "Какой оператор сравнения равенства?",
        kind: "quiz",
        theoryText: "",
        options: ["==", "=", "!=", ">="],
        correctOption: "==",
      ...
      },
      {
        id: 19,
        courseId: 1,
        title: "Как создать пустой словарь?",
        kind: "quiz",
        theoryText: "",
        options: ["{}", "[]", "()", "set()"],
        correctOption: "{}",
      ...
      },
      {
        id: 20,
        courseId: 1,
        title: "Какой метод добавляет элемент в список?",
        kind: "quiz",
        theoryText: "",
      ...
      },
      {
        id: 21,
        courseId: 1,
        title: "Что делает break в цикле?",
        kind: "quiz",
        theoryText: "",
        options: [
          "Прерывает цикл",
      ...
      },
      {
        id: 22,
        courseId: 1,
        title: "Какой блок ловит исключения?",
        kind: "quiz",
        theoryText: "",
      ...
      },
      {
        id: 23,
        courseId: 1,
        title: "Как получить длину строки s?",
        kind: "quiz",
        theoryText: "",
        options: ["len(s)", "s.length", "size(s)", "count(s)"],
        correctOption: "len(s)",
        codeKeyword: "",
        stepOrder: 23,
        xp: 10,
      },
      {
        ...
        theoryText: "",
        options: [
          "Краткий синтаксис для создания списка",
          "Наследование списков",
          "Сортировка списка",
          "Тип списка",
        ],
        correctOption: "Краткий синтаксис для создания списка",
        codeKeyword: "",
        stepOrder: 24,
        xp: 10,
      },

      {
        id: 25,
        courseId: 1,
        title: "Код: сумма двух чисел",
        kind: "code",
        theoryText:
          "Напишите функцию sum_two(a, b), возвращающую сумму двух чисел.",
        options: [],
        correctOption: "",
        codeKeyword: "sum_two",
        stepOrder: 25,
      ...
      },
      {
        id: 26,
        courseId: 1,
        title: "Код: чётное число",
        kind: "code",
        theoryText:
          "Напишите функцию is_even(n), которая возвращает True для четных чисел.",
        options: [],
        correctOption: "",
        codeKeyword: "is_even",
        stepOrder: 26,
      ...
      },
      {
        id: 27,
        courseId: 1,
        title: "Код: максимум в списке",
        kind: "code",
        theoryText:
          "Напишите функцию max_in_list(lst), которая возвращает максимум списка.",
        options: [],
        correctOption: "",
        codeKeyword: "max_in_list",
        stepOrder: 27,
        xp: 20,
      },
      {
        ...
        title: "Код: факториал",
        kind: "code",
        theoryText: "Напишите функцию factorial(n). 0! должно быть равно 1.",
        options: [],
        correctOption: "",
        codeKeyword: "factorial",
        stepOrder: 28,
        xp: 22,
      },
      {
        ...
        kind: "code",
        theoryText:
          "Напишите функцию is_palindrome(s), которая проверяет строку на палиндром.",
        options: [],
        correctOption: "",
        codeKeyword: "is_palindrome",
        stepOrder: 29,
        xp: 22,
      },
      {
        id: 30,
        courseId: 1,
        title: "Код: количество гласных",
        kind: "code",
        theoryText:
          "Напишите функцию count_vowels(s), которая считает гласные в строке.",
        options: [],
        correctOption: "",
        codeKeyword: "count_vowels",
        stepOrder: 30,
        xp: 22,
      },
      {
        id: 31,
        courseId: 1,
        title: "Код: реверс строки",
        kind: "code",
        theoryText:
          "Напишите функцию reverse_string(s), которая переворачивает строку.",
        options: [],
        correctOption: "",
        codeKeyword: "reverse_string",
        stepOrder: 31,
        xp: 22,
      },
      {
        id: 32,
        courseId: 1,
        title: "Код: сумма списка",
        kind: "code",
        theoryText:
          "Напишите функцию sum_list(lst), возвращающую сумму элементов списка.",
        options: [],
        correctOption: "",
        codeKeyword: "sum_list",
        stepOrder: 32,
        xp: 22,
      },
      {
        id: 33,
        courseId: 1,
        title: "Код: проверка простого числа",
        kind: "code",
        theoryText: "Напишите функцию is_prime(n), проверяющую простое число.",
        options: [],
        correctOption: "",
        codeKeyword: "is_prime",
        stepOrder: 33,
        xp: 24,
      },
      {
        id: 34,
        courseId: 1,
        title: "Код: число Фибоначчи",
        kind: "code",
        theoryText:
          "Напишите функцию fibonacci(n), возвращающую n-е число Фибоначчи.",
        options: [],
        correctOption: "",
        codeKeyword: "fibonacci",
        stepOrder: 34,
        xp: 24,
      },
      {
        id: 35,
        courseId: 1,
        title: "Код: уникальные элементы",
        kind: "code",
        theoryText:
          "Напишите функцию unique_items(lst), которая убирает дубликаты.",
        options: [],
        correctOption: "",
        codeKeyword: "unique_items",
        stepOrder: 35,
        xp: 24,
      },
      {
        id: 36,
        courseId: 1,
        title: "Код: сортировка словаря по значению",
        kind: "code",
        theoryText:
          "Напишите функцию sort_dict_by_value(d), сортирующую пары словаря по значению.",
        options: [],
        correctOption: "",
        codeKeyword: "sort_dict_by_value",
        stepOrder: 36,
        xp: 26,
      },
    ],
    ...
    tracks: [
      {
        id: 1,
        name: "Frontend: от основ до проекта",
        status: "in progress",
        progress: 62,
        lessons: 28,
      },
    ...
    faq: [
      {
        id: 1,
        question: "Как отправить решение на проверку?",
        answer: "Откройте страницу задачи и нажмите Проверить.",
      },
      {
        id: 2,
        question: "Где отслеживать прогресс?",
        answer: "На Dashboard и на странице каждого курса.",
      },
    ],
    accountProfiles: [
      {
        ...
        bio: "Администратор платформы Gradus.",
  ...
  try {
    ...
    if (!localStorage.getItem(USERS_RESET_MARKER_KEY)) {
      ...
      parsed.notifications = parsed.notifications.filter(
        (item) => !item.title.toLowerCase().includes("welcome"),
      );
      localStorage.setItem(STORAGE_KEY, JSON.stringify(parsed));
...
async function handleGet<T>(path: string): Promise<T> {
  ...
  if (path === "/landing/stats") {
    ...
    const studentsTotal = courses.reduce((sum, course) => {
      const raw = String(course.students || "0")
        .trim()
        .toLowerCase()
        .replace(/,/g, ".");
  ...
  if (path === "/courses") {
    ...
    return withCourseProgress(db).filter((item) =>
      canAccessCourse(current, item),
    ) as T;
  }
  ...
  if (path === "/dashboard") {
    const current = requireAuth(db);
    const courses = withCourseProgress(db).filter((item) =>
      canAccessCourse(current, item),
    );
    const activeCourses = courses.slice(0, 6);
    const average = courses.length
      ? Math.round(
          courses.reduce((sum, item) => sum + item.progress, 0) /
            courses.length,
        )
      : 0;
    ...
    const unfinishedStep = db.courseSteps
      ...
      .find((step) => {
        const enrolledCourse = courses.some(
          (course) => course.id === step.courseId,
        );
        const completed = db.progress.some(
          (item) =>
            item.courseId === step.courseId &&
            item.stepId === step.id &&
            item.status === "completed",
        );
    ...
    const forecastDays =
      remainingCourseSteps > 0
        ? Math.ceil(remainingCourseSteps / Math.max(stepsPerDay, 0.5))
        : 0;

    const continueCourse = unfinishedStep
      ? courses.find((course) => course.id === unfinishedStep.courseId)
      : null;
    ...
    return {
      ...
      continue: unfinishedStep
        ? {
            ...
            courseTitle:
              continueCourse?.title || `Курс #${unfinishedStep.courseId}`,
      ...
      activities: db.notifications
        .slice(0, 5)
        .map((item, index) => ({ id: index + 1, text: item.title })),
      deadline: {
        title: unfinishedStep
          ? `Следующий шаг: ${unfinishedStep.title}`
          : "Дедлайнов нет",
        text: unfinishedStep
          ? `Курс #${unfinishedStep.courseId}, шаг ${unfinishedStep.stepOrder}`
          : "Вы прошли все доступные шаги.",
      },
    } as T;
  }
  ...
  if (path.startsWith("/analytics")) {
    ...
    const period =
      rawPeriod === "month" || rawPeriod === "месяц" ? "month" : "week";
  ...
  if (path === "/admin/overview") {
    ...
    const publishedCourses = db.courses.filter(
      (item) => item.published !== false,
    ).length;
    const moderationQueue = db.courses.filter(
      (item) => item.published === false,
    ).length;
  ...
  if (path === "/teacher/overview") {
    ...
    const publishedCount = db.courses.filter(
      (item) => item.published !== false,
    ).length;
    const draftCount = db.courses.filter(
      (item) => item.published === false,
    ).length;
    return {
      ...
      stats: {
        ...
        avgProgress: db.courses.length
          ? Math.round(
              db.courses.reduce((sum, item) => sum + item.progress, 0) /
                db.courses.length,
            )
          : 0,
      },
  ...
  if (path === "/admin/analytics") {
    ...
    const conversionRate =
      users > 0
        ? Math.round(
            (courses.filter((item) => item.progress > 0).length / users) * 100,
          )
        : 0;
    ...
    const mrr = paidCourses.reduce((sum, item) => {
      ...
      const studentsNumber =
        Number(String(item.students).replace(/[^0-9.]/g, "")) || 0;
...
async function handlePost<T>(path: string, body: unknown): Promise<T> {
  ...
  if (path === "/auth/login") {
    ...
    if (profile.twoFactorEnabled) {
      ...
      localStorage.setItem(
        MOCK_2FA_LOGIN_CHALLENGE_KEY,
        JSON.stringify({ challengeId, userId: user.id, code }),
      );
      return {
        requiresTwoFactor: true,
        challengeId,
  ...
  if (path === "/account/confirm-email-change") {
    ...
    const occupied = db.users.some(
      (item) => item.id !== current.id && item.email === profile.pendingEmail,
    );
    if (occupied) {
      throw new Error("Пользователь с таким email уже существует");
    }
  ...
  if (path === "/courses") {
    ...
    db.notifications.unshift({
      id: Date.now(),
      title: `Курс ${title} успешно добавлен`,
      time: "Только что",
    });
    setDb(db);
    return created as T;
  ...
  if (path.startsWith("/courses/") && path.endsWith("/enroll")) {
    ...
    if (firstStep) {
      const existing = db.progress.find(
        (item) => item.courseId === courseId && item.stepId === firstStep.id,
      );
      if (!existing) {
        db.progress.push({
          courseId,
    ...
    db.notifications.unshift({
      id: Date.now(),
      title: `${user.name} записался на курс`,
      time: "Только что",
    });
    setDb(db);
    return { success: true } as T;
  ...
  if (path.startsWith("/steps/") && path.endsWith("/check")) {
    ...
    if (step.kind === "theory") {
      ...
      const keywordPassed = step.codeKeyword
        ? answer.toLowerCase().includes(step.codeKeyword.toLowerCase())
        : answer.length > 10;
    ...
    const existing = db.progress.find(
      (item) => item.courseId === step.courseId && item.stepId === step.id,
    );
    if (existing) {
      existing.attempts += 1;
      existing.answerText = answer;
      existing.status = passed ? "completed" : "started";
      existing.score = passed
        ? Math.max(existing.score, step.xp)
        : existing.score;
      existing.completedAt = passed
    ...
    const progress = db.progress.filter(
      (item) => item.courseId === step.courseId,
    );
    const total = db.courseSteps.filter(
      (item) => item.courseId === step.courseId,
    ).length;
    const completed = progress.filter(
      (item) => item.status === "completed",
    ...
    return {
      ...
      feedback: passed
        ? "Решение принято"
        : "Пока не принято. Попробуйте еще раз.",
      checkResults,
      progress: saved,
  ...
  if (path === "/ai/chat") {
    ...
    let reply =
      "Сформулируйте задачу подробнее: цель, текущий код и ожидаемый результат.";
    if (lower.includes("react") || lower.includes("frontend")) {
      reply =
        "Рекомендую начать с decomposition: выделите UI-компоненты, затем состояния по feature-slice, после чего добавьте валидацию и optimistic updates для UX.";
    } else if (
      lower.includes("sql") ||
      ...
      reply =
        "Для backend сначала зафиксируйте контракт endpoint, затем добавьте индексы на поля фильтрации и проверьте edge-case ошибки через integration tests.";
    } else if (lower.includes("алгоритм") || lower.includes("leetcode")) {
      reply =
        "Опишите ограничения задачи, затем сравните brute-force и оптимальный подход по сложности, после чего добавьте тесты на крайние случаи.";
    }

    db.notifications.unshift({
      id: Date.now(),
      title: "AI-ассистент ответил на ваш запрос",
      time: "Только что",
    });
    setDb(db);
  ...
  if (path === "/assignments") {
    ...
    const assignment: Assignment = {
      ...
      tags: Array.isArray(payload?.tags)
        ? payload.tags.filter((item) => item.trim()).slice(0, 8)
        : [],
...
async function handleDelete<T>(path: string): Promise<T> {
  ...
  if (path.startsWith("/admin/users/")) {
    ...
    db.accountProfiles = db.accountProfiles.filter(
      (item) => item.userId !== id,
    );
    setDb(db);
    return { success: true } as T;
  ...
  if (canUseBackend()) {
    try {
      ...
      if (path === "/student/weekly-goal" && method === "PATCH") {
        const data = await backendRequest<{ goal: number }>(
          "/student/weekly-goal",
          {
            method: "PATCH",
      ...
      if (path === "/ai/chat" && method === "POST") {
        ...
        const data = await backendRequest<{ reply: string; model: string }>(
          "/ai/chat",
          {
            method: "POST",
            body: JSON.stringify(payload),
      ...
      if (
        /^\/courses\/\d+\/enrollment-status$/.test(path) &&
        method === "GET"
      ) {
        const courseId = path.split("/")[2];
        const data = await backendRequest<{
      ...
      if (
        /^\/courses\/\d+\/request-enrollment$/.test(path) &&
        method === "POST"
      ) {
        const courseId = path.split("/")[2];
      ...
      if (
        /^\/teacher\/enrollment-requests\/\d+$/.test(path) &&
        method === "PATCH"
      ) {
      ...
      if (
        /^\/teacher\/courses\/\d+\/structure$/.test(path) &&
        method === "GET"
      ) {
        const courseId = path.split("/")[3];
        const data = await backendRequest<{
      ...
      if (
        ...
        path === "/courses" ||
        /^\/courses\/\d+\/(enroll|steps|detail|enrollment-status|request-enrollment)$/.test(
          path,
        ) ||
        /^\/steps\/\d+\/check$/.test(path) ||
